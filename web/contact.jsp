<%-- 
    Document   : contact
    Created on : 06/05/2021, 01:20:12 PM
    Author     : marlo
--%>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        <li class="nav-item active">
                                            <a class="nav-link active" href="index.jsp">Home<span class="sr-only">(current)</span></a> </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="about.jsp">About</a></li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="company.jsp">Company</a></li>
                                        <li class="#" href="#">
                                            <a class="nav-link" href="furnitures.jsp">Furnitures</a></li>
                                        <li class="nav-item" href="#">
                                            <a class="nav-link" href="contact.jsp">Contact Us</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="useful_main border_right0">
                            ...
                            <ul >
                                ...
                                <li><a href="furnitures.jsp">Furnitures</a></li>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 ">
                        ...
                        <ul class="location">
                            ...
                            <li><img src="images/call-icon.png"><a href="company.jsp">+71 89078493</a></li>
                            <li><img src="images/email-icon.png"><a href="furnitures.jsp">demo@gmail.com</a></li>
