<%-- 
    Document   : index2
    Created on : 06/05/2021, 01:14:59 PM
    Author     : marlo
--%>
...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        <li class="nav-item active">
                                            <a class="nav-link active" href="index.jsp">Inicio<span class="sr-only">(current)</span></a> </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="about.jsp">Nosotros</a></li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="company.jsp">Compañia</a></li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="furnitures.jsp">Productos</a></li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="contact.jsp">Contáctanos</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <h1 class="trends_text">Mungo</h1>
                                        <h1 class="furniture_text">Anclaje</h1>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <h1 class="furniture_text">2021</h1>
                                        <h1 class="trends_text">BN</h1>
                                        <h1 class="furniture_text">21000</h1>
                                        <P class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, </P>
                                        <button class="more_bt">MORE INFO</button>
                                        <button class="furniture_bt">FURNITURE</button>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <h1 class="furniture_text">2021</h1>
                                        <h1 class="trends_text">BN</h1>
                                        <h1 class="furniture_text">21012</h1>
                                        <P class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, </P>
                                        <button class="more_bt">MORE INFO</button>
                                        <button class="furniture_bt">FURNITURE</button>
                                    </div>
        ...
        <div class="layout_padding about_section ">
            <div class="container">
                <h1 class="about_taital">Quiénes <span style="background-color: #fee421; color: #fff; padding: 0px 5px;">Somos</span></h1>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <p class="about_long_text">Fixa S.A. es una empresa en Perú, con sede principal en Callao. 
                                Opera en Comerciantes al por Mayor de Equipos y Suministros para Uso Profesional y 
                                Comercial industrian , para solucionar problemas industriales en anclajes. 
                                La empresa fue fundada en 03 de marzo de 1958.</p>
                            <button class="about_bt">Más Sobre Nosotros</button>
                        </div>
                        <div class="col-md-4">
        ...
        <div class="our_furniture_section layout_padding">
            <div class="container">
                <h1 class="about_taital">Nuestros <span style="background-color: #fee421; color: #fff; padding: 0px 5px;">Productos</span></h1>
            ...
            <div class="container">
                <div id="my_carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <h1 class="testi_monila_text">Equipo <span style="background-color: #fee421; color: #fff; padding: 0px 5px;">Fixa</span></h1>
                            <div class="testimonila_inner">
                                <div class="testing_img"><img src="images/img-10.png"></div>
                                <h2 class="helina_text">Helina</h2>
                                <p class="dolor_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
                    ...
                    <div class="contact_main">
                        ...
                        <div class="input_main">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group">
                                        <input type="text" class="email-bt" placeholder="Número celular" name="Email">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group">
                        ...
                        <div class="massage_box">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <button class="send_bt">Enviar</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="useful_main border_right0">
                            ...
                            <ul >
                                ...
                                <li><a href="furnitures.jsp">Productos</a></li>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 ">
                        <h2 class="useful_text">Dirección</h2>
                        <ul class="location">
                            <li><img src="images/map-icon.png">Locations</li>

                            <li><img src="images/call-icon.png"><a href="company.jsp">+51 990761223</a></li>
                            <li><img src="images/email-icon.png"><a href="furnitures.jsp">fixa@gmail.com</a></li>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 ">
                        <h2 class="useful_text">Boletin informativo</h2>
                        <div class="form-group">
        ...
        <div class="copyright">
            <div class="container">
                <p class="copyright_text">Copyright 2021 All Right Reserved By</p>
            </div>
        </div>
